...
void HashTable::hashdisplayall() {
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        {
            x++;
            cout << "the " << x << " ) " << "user" << " name is " << temp->valu.name << endl;
            cout << "the " << x << " ) " << "user" << " id is " << temp->valu.ID << endl;
            cout << "the " << x << " ) " << "user" << " age is" << temp->valu.age << endl;
            cout << "the " << x << " ) " << "user" << " gender is" << temp->valu.gender << endl;
            cout << "the " << x << " ) " << "user" << " governorate" << temp->valu.governorate << endl;
            cout << "the " << x << " ) " << "user" << " password is" << temp->valu.pass << endl;
            if (temp->valu.Vaccine)
            {
                cout << "the user is vaccinated" << endl;
                cout << "the " << x << " ) " << "user" << " dose is" << temp->valu.dose << endl;
            }
            else {

                cout << "the user is not vaccinated" << temp->valu.dose << endl;
            }            temp = temp->next;
